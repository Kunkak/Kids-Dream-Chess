...
public abstract class Piece : MonoBehaviour
{
    ...
    public void ChangeType(string to)
    {
        ...
        newPiece = to switch
        {
            "queen" => Resources.Load($"Prefabs/{color} pieces/{color[0]}Queen"),
            "rook" => Resources.Load($"Prefabs/{color} pieces/{color[0]}Rook"),
            "bishop" => Resources.Load($"Prefabs/{color} pieces/{color[0]}Bishop"),
            "knight" => Resources.Load($"Prefabs/{color} pieces/{color[0]}Knight"),
            "pawn" => Resources.Load($"Prefabs/{color} pieces/{color[0]}Pawn"),
            _ => Resources.Load($"Prefabs/{color} pieces/{color[0]}Queen"),
        };
